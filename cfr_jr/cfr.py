...
import cfr_jr.policy as policy
import pyspiel
...
class _CFRSolverBase(object):
  ...
  def __init__(self, game, alternating_updates, linear_averaging,
               regret_matching_plus, blueprint=False):
    # pyformat: disable
    """Initializer.
    ...
    self._current_policy = policy.TabularPolicy(game, blueprint=blueprint)
...
class CFRSolver(_CFRSolver):
  ...
  def __init__(self, game,  blueprint=False):
